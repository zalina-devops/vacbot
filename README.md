...
### Список вакансий
![Список вакансий](docs/screenshots/03_vacancies.png)
...
*Генерация сопроводительных писем через Claude AI*

### AI-адаптация резюме
![AI-адаптация](docs/screenshots/05_ai_modal_2.png)

*Адаптация резюме через Claude AI*

### Профиль пользователя
![Профиль](docs/screenshots/06_profile.png)
...
### PDF-резюме
![PDF-резюме](docs/screenshots/08_resume_pdf.png)

*Готовое резюме в PDF-формате*

### Настройки
![Настройки](docs/screenshots/09_settings.png)

*Настройки фильтра, сброс базы данных*
